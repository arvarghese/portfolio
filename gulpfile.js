...
gulp.task('serve', function () {
  ...
  gulp.watch('assets/css/portfolio.css', ['minify-css']);
  gulp.watch("assets/js/portfolio.ts", ["typescript"]);
  gulp.watch('assets/js/portfolio.js', ['minify-js']);
